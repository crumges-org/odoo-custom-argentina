...
Cargar facturas manualmente es propenso a errores y consume mucho tiempo. Este módulo permite importar directamente el archivo de "Mis Comprobantes" de AFIP (ARCA), creando automáticamente facturas, clientes/proveedores y validando datos clave.
...
*   **Integración CIE:** Transcribe automáticamente el Código de Autorización Electrónico (CAE) a las facturas.

Uso
---
1.  Descargue el archivo Excel de "Mis Comprobantes" desde el portal de ARCA.
2.  Vaya a **Contabilidad > Importar de ARCA > Nuevo Importación**.
3.  Suba el archivo y seleccione el tipo de operación.
